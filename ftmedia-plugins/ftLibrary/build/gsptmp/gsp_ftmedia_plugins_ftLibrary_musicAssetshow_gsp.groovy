...
printHtmlPart(4)
invokeTag('display','f',10,['bean':("musicAsset")],-1)
printHtmlPart(5)
createTagBody(2, {->
printHtmlPart(6)
createTagBody(3, {->
...
invokeTag('link','g',13,['class':("edit btn btn-primary"),'action':("edit"),'resource':(this.musicAsset)],3)
printHtmlPart(7)
...
invokeTag('form','g',16,['resource':(this.musicAsset),'method':("DELETE")],2)
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1465138911944L

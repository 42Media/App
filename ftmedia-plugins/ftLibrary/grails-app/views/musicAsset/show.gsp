                ...
                <div class="panel-body">
                    ...
                    <g:form resource="${this.musicAsset}" method="DELETE">
                        <fieldset class="buttons">
                            ...
                            <g:link class="edit btn btn-primary"  data-toggle="modal" data-target="#modal-edit" action="edit" resource="${this.musicAsset}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
